        ...
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (nameCompare != 0) {
                    ...
                    int dateCompare = format.format(date1).compareTo(format.format(date2));
                    if (dateCompare != 0) {
                        return -dateCompare;
                    }
                    else {
                        if (stock1.containsKey("open") && stock2.containsKey("last")){
                            double change1 = (double) stock1.get("last") - (double) stock1.get("open");
                            double change2 = (double) stock2.get("last") - (double) stock2.get("open");
                            int changeCompare = Double.compare(change1, change2);
